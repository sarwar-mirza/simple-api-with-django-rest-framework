...
SECRET_KEY = 'django-insecure-p)1hjb-w7lj1n^e=u$hvq=urlbv+198f_$+r@aba&j_h=hbsd3'
...
INSTALLED_APPS = [
    ...
    'core',         # inside create new application
    'enroll',       # inside create new application
    'api',          # inside create new application
]
